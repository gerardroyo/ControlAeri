...
public class Encrypt {
    ...
    public static void encrypt(CommercialAirPlane airPlane) {
       /* // Generar el par de claves
        ...
        // Texto a encriptar
        String licensePlate = airPlane.getLicensePlate();


        // Se encripta
        rsa.init(Cipher.ENCRYPT_MODE, publicKey);
        byte[] encriptado = rsa.doFinal(licensePlate.getBytes());
    ...
    public static void decrypt(CommercialAirPlane airPlane) {
        // Generar el par de claves
        KeyPairGenerator keyPairGenerator = KeyPairGenerator.getInstance("RSA");
        KeyPair keyPair = keyPairGenerator.generateKeyPair();
        PublicKey publicKey = keyPair.getPublic();
